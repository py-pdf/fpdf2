...
class GradientPaint:
    ...
    def has_alpha(self) -> bool:
        return (
            ...
            and self.gradient.has_alpha()
            and not self.skip_alpha
        )
...
class DrawingContext:
    ...
    def render(
        ...
        if (
            style.soft_mask is not None
            and not isinstance(style.soft_mask, InheritType)
...
class GraphicsContext:
    ...
    def build_render_list(
        ...
        if self.path_items:
            ...
            if (
                emit_style.soft_mask is not None
                and not isinstance(emit_style.soft_mask, InheritType)
...
class PathPen(BasePen):  # type: ignore[misc]
    def __init__(
        self, pdf_path: ClippingPath | PaintedPath, glyphSet: "ttGlyphSet" = None
    ) -> None:

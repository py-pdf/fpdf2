...
class TestSVGGradients:
    ...
    def test_gradient_units_objectBoundingBox(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
        ...
        assert (
            svg_obj.gradient_definitions["#grad"].units
            == GradientUnits.OBJECT_BOUNDING_BOX
        )

    def test_gradient_units_userSpaceOnUse(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
    ...
    def test_gradient_on_stroke(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
    ...
    def test_gradient_with_gradientTransform(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
    ...
    def test_gradient_without_id_is_skipped(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient>
    ...
    def test_gradient_without_stops_is_skipped(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
    ...
    def test_gradient_percentage_coordinates(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
    ...
    def test_gradient_absolute_coordinates(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
    ...
    def test_gradient_on_path(self):
        svg = """
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="grad">
    ...
    def test_gradient_on_shapes(self):
        svg = """

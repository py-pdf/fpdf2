...
def test_flextemplate_elements(tmp_path):
    ...
    text_elements = (
            dict(name='t', type='T', x1=0,  y1=0, x2=10, y2=4, text="text0", background=0xffff00),
            dict(name='t2', type='T', x1=20,  y1=0, x2=30, y2=4, text="text2", background=0xffbb00),
            dict(name='t3', type='T', x1=00,  y1=30, x2=10, y2=34, text="text3", background=0xbbbf00, rotate=10),
            )
    ml_elements = (
            dict(name='ml', type='T', x1=0,  y1=0, x2=15, y2=4, text="Lorem ipsum dolor sit amet", multiline=True),
            dict(name='ml2', type='T', x1=20,  y1=0, x2=35, y2=4, text="Lorem ipsum dolor sit amet", multiline=True),
            dict(name='ml3', type='T', x1=00,  y1=30, x2=15, y2=34, text="Lorem ipsum dolor sit amet", multiline=True, rotate=10),
            )
    write_elements = (
            dict(name='w', type='W', x1=0,  y1=0, x2=10, y2=4, text="write0", background=0xffff00),
            dict(name='w2', type='W', x1=20,  y1=0, x2=30, y2=4, text="write2", background=0xffbb00),
            dict(name='w3', type='W', x1=00,  y1=30, x2=10, y2=34, text="write3", background=0xbbbf00, rotate=10),
            )
    line_elements = (
    ...
    bc_elements = (
            ...
            dict(name='bc3', type='BC', x1=00,  y1=30, x2=10, y2=34, text="01", size=1, rotate=10),
        )
    c39_elements = (
            ...
            dict(name='c39_3', type='C39', x1=00,  y1=30, x2=10, y2=34, text="*01*", size=0.7, rotate=10),
        )
    img_elements = (

...
### Changed
* Removed an obscure and undocumented feature of [`FPDF.write_html()`](https://py-pdf.github.io/fpdf2/fpdf/fpdf.html#fpdf.fpdf.FPDF.write_html), which magically passed local variables as arguments.

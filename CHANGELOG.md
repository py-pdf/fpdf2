...
* escaped markdown markers inside markdown links no longer leave stray escape backslashes in the rendered text nor produce double-escaped output in the `LINES` re-serialization - _cf._ [issue #1847](https://github.com/py-pdf/fpdf2/issues/1847)
### Changed
